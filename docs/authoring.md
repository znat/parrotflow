...
| Where | Sets |
|---|---|
| `examples/transforms/<name>/` | `code_identifiers` (78), `dotted` (84), `dates` (133, two languages), `numbers` (99, two languages), `punctuation` (57), `grammar` (17), `email` (26), `repetitions` (60), `self_correction` (89) |
